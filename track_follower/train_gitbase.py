...
image_files = glob.glob(os.path.join(DATA_PATH, 'track_dataset_*', '*.jpg'))
...
MODEL_PATH = '/abr/coss11/repo/Track_Model.h5'
...
# 모델 저장
model.save('/abr/coss11/repo/Track_Model_1.h5')
print("Model saved to /abr/coss11/repo/Track_Model_1.h5")    